...
- **Amendments**: Changed from `amendments-1.20-1.1.31-fabric.jar` to `amendments-1.20-1.2.19-fabric.jar`
...
- **Balm**: Changed from `balm-fabric-1.20.1-7.2.2.jar` to `balm-fabric-1.20.1-7.3.27.jar`
...
- **Chat Heads**: Changed from `chat_heads-0.12.2-fabric-1.20.jar` to `chat_heads-0.13.18-fabric-1.20.jar`
...
- **Collective**: Changed from `collective-1.20.1-7.80.jar` to `collective-1.20.1-8.3.jar`
...
- **Connectivity**: Changed from `connectivity-fabric-1.20.1-5.5.jar` to `connectivity-fabric-1.20.1-7.1.jar`
- **Continuity**: Changed from `continuity-3.0.0-beta.5+1.20.1.jar` to `continuity-3.0.0+1.20.1.jar`
- **CraterLib**: Changed from `CraterLib-Fabric-1.20-1.1.1.jar` to `CraterLib-Fabric-1.20-2.1.4.jar`
...
- **e4mc**: Changed from `e4mc-4.0.1+1.19.4-fabric.jar` to `e4mc_minecraft-fabric-5.3.1.jar`
- **Eldritch End**: Changed from `Eldritch_End-FABRIC-MC1.20.1-0.2.31.jar` to `Eldritch_End-FABRIC-MC1.20.1-0.3.3.jar`
...
- **EMI Loot**: Changed from `emi_loot-0.6.6+1.20.1.jar` to `emi_loot-0.7.6+1.20.1+fabric.jar`
...
- **Every Compat**: Changed from `everycomp-1.20-2.6.55-fabric.jar` to `everycomp-1.20-2.8.2-fabric.jar`
- **Exordium**: Changed from `exordium-fabric-1.2.1-mc1.20.1.jar` to `exordium-fabric-1.4.1-mc1.20.1.jar`
...
- **Fabric API**: Changed from `fabric-api-0.92.2+1.20.1.jar` to `fabric-api-0.92.5+1.20.1.jar`
- **Fabric Language Kotlin**: Changed from `fabric-language-kotlin-1.11.0+kotlin.2.0.0.jar` to `fabric-language-kotlin-1.13.2+kotlin.2.1.20.jar`
- **Wraith Waystones**: Changed from `wraith-waystones-3.3.2+mc1.20.1.jar` to `wraith-waystones-3.3.3+mc1.20.1.jar`
- **Farmer's Delight Refabricated**: Changed from `FarmersDelight-1.20.1-2.1.1+refabricated.jar` to `FarmersDelight-1.20.1-2.3.0+refabricated.jar`
- **Fast Async World Save**: Changed from `fastasyncworldsave-fabric-1.20.1-1.9.jar` to `fastasyncworldsave-fabric-1.20.1-2.4.jar`
- **Forge Config API Port**: Changed from `ForgeConfigAPIPort-v8.0.0-1.20.1-Fabric.jar` to `ForgeConfigAPIPort-v8.0.2-1.20.1-Fabric.jar`
...
- **Fzzy Config**: Changed from `fzzy_config-0.3.3+1.20.1.jar` to `fzzy_config-0.6.9+1.20.1.jar`
- **GeckoLib**: Changed from `geckolib-fabric-1.20.1-4.4.4.jar` to `geckolib-fabric-1.20.1-4.7.1.2.jar`
- **Geophilic – Vanilla Biome Overhauls**: Changed from `geophilic-v2.2.0-mc1.20u1.20.2.jar` to `Geophilic v3.4.1 f15-71.mod.jar`
- **Harvest with ease**: Changed from `harvestwithease-1.20.1-8.0.1.0-fabric.jar` to `harvest-with-ease-fabric-1.20.1-9.4.0.jar`
- **Hearths**: Changed from `hearths-v1.0.0.jar` to `Hearths v1.0.3 f12-71.jar`
- **Iceberg**: Changed from `Iceberg-1.20.1-fabric-1.1.18.jar` to `Iceberg-1.20.1-fabric-1.1.25.jar`
- **ImmediatelyFast**: Changed from `ImmediatelyFast-Fabric-1.2.13+1.20.4.jar` to `ImmediatelyFast-Fabric-1.5.0+1.20.4.jar`
- **Immersive Armors**: Changed from `immersive_armors-1.6.1+1.20.1-fabric.jar` to `immersive_armors-1.7.0+1.20.1-fabric.jar`
- **Integrated API**: Changed from `integrated_api-1.5.1+1.20.1-fabric.jar` to `integrated_api-1.5.3+1.20.1-fabric.jar`
- **Inventory Profiles Next**: Changed from `InventoryProfilesNext-fabric-1.20-1.10.10.jar` to `InventoryProfilesNext-fabric-1.20-1.10.12.jar`
- **InvMove**: Changed from `InvMove-1.20-0.8.4-Fabric.jar` to `InvMove-0.9.0+1.20.1-Fabric.jar`
...
- **LambDynamicLights**: Changed from `lambdynamiclights-2.3.2+1.20.1.jar` to `lambdynamiclights-4.1.2+1.20.1.jar`
...
- **Lithium**: Changed from `lithium-fabric-mc1.20.1-0.11.2.jar` to `lithium-fabric-mc1.20.1-0.11.3.jar`
- **Lithostitched**: Changed from `lithostitched-fabric-1.20.1-1.1.5.jar` to `lithostitched-fabric-1.20.1-1.4.4.jar`
- **MCPitanLib**: Changed from `mcpitanlib-2.2.4-1.20.1-fabric.jar` to `mcpitanlib-3.2.5-1.20.1-fabric.jar`
- **Memory Settings**: Changed from `memorysettings-fabric-1.20.1-5.3.jar` to `memorysettings-fabric-1.20.1-5.9.jar`
- **Mine Cells - Dead Cells Mod**: Changed from `minecells-1.7.4.jar` to `minecells-1.9.2.jar`
- **MmmMmmMmmMmm**: Changed from `dummmmmmy-1.20-1.8.17b-fabric.jar` to `dummmmmmy-1.20-2.0.6-fabric.jar`
- **MNS - Moog's Nether Structures**: Changed from `mns-1.0.1-1.20-fabric.jar` to `mns-1.0.3-1.20-fabric.jar`
- **ModernFix**: Changed from `modernfix-fabric-5.18.6+mc1.20.1.jar` to `modernfix-fabric-5.21.0+mc1.20.1.jar`
...
- **More Armor Trims**: Changed from `morearmortrims-1.2.0.jar` to `morearmortrims-1.4.2-1.20.1.jar`
...
- **Neruina - Ticking Entity Fixer**: Changed from `neruina-fabric-2.0.0-beta.10+1.20.1.jar` to `Neruina-2.3.1-beta.1-fabric+1.20.1.jar`
...
- **Not Enough Animations**: Changed from `notenoughanimations-fabric-1.7.3-mc1.20.1.jar` to `notenoughanimations-fabric-1.9.3-mc1.20.1.jar`
...
- **Open Parties and Claims**: Changed from `open-parties-and-claims-fabric-1.20.1-0.22.0.jar` to `open-parties-and-claims-fabric-1.20.1-0.24.0.jar`
...
- **Packet Fixer**: Changed from `packetfixer-fabric-1.4.0-1.19-to-1.20.1.jar` to `packetfixer-fabric-2.0.0-1.19-to-1.20.1.jar`
- **Paladins & Priests**: Changed from `paladins-1.3.1+1.20.1.jar` to `paladins-1.4.0+1.20.1.jar`
- **Particle Core**: Changed from `particle_core-0.2.3+1.20.1.jar` to `particle_core-0.2.6+1.20.1.jar`
...
- **Pufferfish's Attributes**: Changed from `puffish_attributes-0.5.0-1.20-fabric.jar` to `puffish_attributes-0.7.3-1.20-fabric.jar`
- **Pufferfish's Skills**: Changed from `puffish_skills-0.12.2-1.20-fabric.jar` to `puffish_skills-0.15.5-1.20-fabric.jar`
- **Puzzles Lib**: Changed from `PuzzlesLib-v8.1.20-1.20.1-Fabric.jar` to `PuzzlesLib-v8.1.32-1.20.1-Fabric.jar`
...
- **Respawning Structures**: Changed from `respawningstructures-fabric-1.20.1-2.5.jar` to `respawningstructures-fabric-1.20.1-3.8.jar`
...
- **Philip's Ruins**: Changed from `Philips-Ruins1.20.1-3.9.1[Fabric].jar` to `PhilipsRuins1.20.1-5.3-Fabric.jar`
...
- **Moonlight Lib**: Changed from `moonlight-1.20-2.11.30-fabric.jar` to `moonlight-1.20-2.14.1-fabric.jar`
...
- **Simple Discord RPC**: Changed from `SimpleRPC-fabric-1.20-3.2.4.jar` to `SimpleRPC-Universal-4.0.2.jar`
- **Simple Voice Chat**: Changed from `voicechat-fabric-1.20.1-2.5.15.jar` to `voicechat-fabric-1.20.1-2.5.30.jar`
...
- **Skin Layers 3D**: Changed from `skinlayers3d-fabric-1.6.5-mc1.20.1.jar` to `skinlayers3d-fabric-1.7.5-mc1.20.1.jar`
...
- **Sophisticated Backpacks**: Changed from `sophisticatedbackpacks-3.19.5+mc1.20.1-SNAPSHOT-build.76.jar` to `sophisticatedbackpacks-1.20.1-3.23.4.1.95.jar`
- **Sophisticated Core**: Changed from `sophisticatedcore-0.5.109+mc1.20.1-SNAPSHOT-build.76.jar` to `sophisticatedcore-1.20.1-1.2.7.2.139.jar`
...
- **Structure Essentials**: Changed from `structureessentials-fabric-1.20.1-3.4.jar` to `structureessentials-fabric-1.20.1-4.7.jar`
- **Styled Chat**: Changed from `styled-chat-2.2.3+1.20.1.jar` to `styled-chat-2.2.4+1.20.1.jar`
- **Supplementaries**: Changed from `supplementaries-1.20-2.8.11-fabric.jar` to `supplementaries-1.20-3.1.30-fabric.jar`
- **Tectonic**: Changed from `tectonic-fabric-1.20-2.3.4.jar` to `tectonic-fabric-1.20.1-2.4.4.jar`
...
- **Vinery**: Changed from `letsdo-vinery-fabric-1.4.19.jar` to `letsdo-vinery-fabric-1.4.39.jar`
- **Wavey Capes**: Changed from `waveycapes-fabric-1.4.7-mc1.20.1.jar` to `waveycapes-fabric-1.5.2-mc1.20.1.jar`
...
- **Xaero's Minimap**: Changed from `Xaeros_Minimap_24.1.1_Fabric_1.20.jar` to `Xaeros_Minimap_25.2.0_Fabric_1.20.jar`
- **Xaero's World Map**: Changed from `XaerosWorldMap_1.38.4_Fabric_1.20.jar` to `XaerosWorldMap_1.39.4_Fabric_1.20.jar`
