...
- Fixed permadeath text showing up when not supposed to while respawning normally.
...
- Refreshed design of server spawn structure to include the rtp portal and buyable respawn mechanic as seen on the official server.
